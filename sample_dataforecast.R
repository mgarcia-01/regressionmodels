...
# https://github.com/PetoLau/petolau.github.io/blob/master/_Rscripts/1post-EnernocDataForecast.R
# ggmap terms and conditions http://developers.google.com/maps/terms
library(data.table)
library(lubridate)
library(ggplot2)
library(ggmap)
